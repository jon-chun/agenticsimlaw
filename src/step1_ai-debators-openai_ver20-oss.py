...
MAX_API_TIME_SEC = 45.0

INPUT_VIGNETTES_CSV = "vignettes_final_clean.csv" 
DATASET_TYPE="vignettes_final_clean"
...
LOG_OUTPUT_FILENAME = f"log_transcript_{DATETIME_RUNSTART}.txt"
...
# hacked down to reduce redudancy
...
# OLLAMA_ENSEMBLE_REASONING_LS needs editing to narrow down the list of models focused on reasoning like tulu3
...
OLLAMA_MODEL_LS = OLLAMA_ENSEMBLE_OSS_LS
OLLAMA_MODEL_LS = ["hermes3:8b-llama3.1-q4_K_M"]
'''
OLLAMA_MODEL_LS = [
    "llama3.1:8b-instruct-fp16", 
    "phi4:14b-fp16",
